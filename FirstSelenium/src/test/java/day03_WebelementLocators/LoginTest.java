...
public class C02_LoginTest {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        WebElement signInLinki=driver.findElement(By.id("sign-in")); //sadece locate edip bir veriable'ye assign ettik
        signInLinki.click();

        //    c. email textbox,password textbox, and signin button elementlerini locate ediniz..

        WebElement emailTextBox=driver.findElement(By.id("session_email"));
        WebElement passowordTextBox=driver.findElement(By.id("session_password"));
        ...
        passowordTextBox.sendKeys("Test1234!");
    ...
    WebElement girisYazisiElementi=driver.findElement(By.tagName("h1"));
        ...
        String actuelGirisYazisi=girisYazisiElementi.getText();
        String exepectedGirisYazisi="Welcome to Address Book";

        if (actuelGirisYazisi.equals(exepectedGirisYazisi)){
