...
public class C02_RelativeXpath {
    public static void main(String[] args) {
        ...
        // once uzerlerinden tarif yapacagimiz webelementlerini locate etmeliyiz
        ...
        String actualIdDegeri2=berlin1.getAttribute("id");
        String actualIdDegeri3=berlin1.getAttribute("id");

        if (expectedIdDegeri.equals(actualIdDegeri1)){
            System.out.println("1. Relative locate testi PASS");
        }else  System.out.println("1. Relative locate testi FAILED");

        if (expectedIdDegeri.equals(actualIdDegeri2)){
            System.out.println("2. Relative locate testi PASS");
        }else  System.out.println("2. Relative locate testi FAILED");

        if (expectedIdDegeri.equals(actualIdDegeri3)){
            System.out.println("3. Relative locate testi PASS");
        }else  System.out.println("3. Relative locate testi FAILED");
