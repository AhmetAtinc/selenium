...
public class C02_Xpath {
    public static void main(String[] args) {
        ...
        if (deleteButonu.isDisplayed()){
            System.out.println("Delete butonu gorunutor testi PASS");
        }else System.out.println("Delete butonu gorunuyor testi FAILED");
        ...
        if (addYazisiElementi.isDisplayed()){
            System.out.println("Add yazisi gorunutor testi PASS");
