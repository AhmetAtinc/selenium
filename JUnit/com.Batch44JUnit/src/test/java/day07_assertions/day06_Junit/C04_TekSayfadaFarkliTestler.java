...
public class C04_TekSayfadaFarkliTestler {
  ...
  static   WebElement sonucYazisiElementi;
    @Test
    public void test01(){
        // amazon sayfasinda nutella icin arama yapip sonuc yazsisinin nutella icerdigini test edelim
    ...
    @Test
    public void test02(){
        // amazon sayfasinda java icin arama yapip sonuc yazsisinin java icerdigini test edelim
    ...
    @Test
    public void test03(){
        // amazon sayfasinda ali icin arama yapip sonuc yazsisinin ali icerdigini test edelim
        aramaKutusu=driver.findElement(By.id("twotabsearchtextbox"));
        aramaKutusu.clear();
        ...
        }else    System.out.println("Ali testi FAILED");
