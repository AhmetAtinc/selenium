...
public class C01DependsOnMethods {
    ...
    public void fiyatTesti(){
        ...
        WebElement actualFiyat=driver.findElement(By.xpath("//span[@class='a-size-base a-color-price']"));
       String actualFiyatElementi= actualFiyat.getText();
       String expectedFiyatElementi="$14.99";
       Assert.assertTrue(actualFiyatElementi.contains(expectedFiyatElementi));
    }
